...
function createTodos(todoList) {
    ...
    if (todoForm) todoForm.addEventListener("submit", (event)=>{
        event.preventDefault();
        const taskInputEl = document.getElementById("task");
        const priorityInputEl = document.getElementById("priority");
...
/* Moment 2 DT208G OOP i TypeScript 
 Maamoun Okla, maok1900@student.miun.se 
 2024-04-06 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class TodoList {
    ...
    addTodo(task, priority) {
        ...
        if (priority != 0 && task != "") {
            ...
            this.displayError("Du m\xe5ste fylla i b\xe5de uppgiften och prioriteten f\xf6r denna uppgift!");
            return false;
        }
    }
    //Markera todo klar
...
},{}]},["dZI1r","jeorp"], "jeorp", "parcelRequire7fcd")
